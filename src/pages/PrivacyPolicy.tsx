    ...
    render() {
        return(
            <Container fluid className='h-100 w-75'>
                ...
                <p className='lead'>
                    <b>Personal information you disclose to us.</b><br/>
                    <b>In short:</b> <i>We collect personal information that you provide to us.</i><br/>
                    ...
                    <b>Sensitive information.</b> We do not process sensitive information.<br/>
                ...
                <p className='lead'>
                    <b>In short:</b> <i>We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent.</i><br/>
                    <br/>
                ...
                <p className='lead'>
                    <b>In short:</b> <i>Yes, we will update this notice as necessary to stay compliant with relevant laws.</i><br/>
                    <br/>
